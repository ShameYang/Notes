...
/*
	...
	Tomcat 服务器的 logs 目录下有哪些文件
	catalina.date.log 服务器端的 java 程序运行的控制台信息
	localhost.date.log ServletContext 对象的 log 方法记录的日志信息
...
```java
//存（向 ServletContext 应用域中存数据）
public void setAttribute(String name, Object value); // map.put(k, v)

//取（从 ServletContext 应用域取数据）
...
~~~java
// uri?username=xxx&userpwd=123，获取的是用户在浏览器上提交的数据
